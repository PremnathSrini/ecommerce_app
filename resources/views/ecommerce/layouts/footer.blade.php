        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer-menu">
                    <img src="{{ asset('assets/images/logo.svg') }}" width="240" height="70"
                        alt="logo">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer-menu">
                    ...
                    <form class="d-flex mt-3 gap-0" action="index.html">
                        <input class="form-control rounded-start rounded-0 bg-light" type="email" name="footer_email" id="footer_email"
